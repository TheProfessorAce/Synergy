...
public class worldUtils {
    ...
    public static Body createPowerUps(World world, float x, float y, int mode) {
        ...
        fixtureDef.filter.categoryBits = constants.NOTHING;
        fixtureDef.filter.groupIndex = constants.LIGHT;
        fixtureDef.filter.maskBits = constants.IGNORE|constants.NOTHING;
